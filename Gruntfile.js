    ...
    usemin: {
      ...
      options: {
        assetsDirs: [
          ...
          '<%= yeoman.dist %>/<%= yeoman.client %>/assets/icon'
        ],
    ...
    imagemin: {
      dist: {
        files: [{
          ...
          expand: true,
          cwd: '<%= yeoman.client %>/assets/icon',
          src: '{,*/}*.*',
          dest: '<%= yeoman.dist %>/<%= yeoman.client %>/assets/icon'
        }
        ]
      }
    },
